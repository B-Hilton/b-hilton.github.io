...
- `.github/instructions/markdown-content.instructions.md` (applies to content collections) – Guidance for creating content in `_news/`, `_pages/`, `_posts/`, `_projects/` with appropriate frontmatter and formatting
