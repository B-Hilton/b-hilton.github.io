...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/past_projects/bug.png" title="a hardware bug" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/past_projects/tube_furnace.jpg" title="Into the Dragon's Lair" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
